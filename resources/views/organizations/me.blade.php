...
@section('content')
    ...
    @else
<p>
    Die folgenden Daten werden automatisch übertragen. Fehler können über <a href="https://www.4juh.de/workspaces/sanitaetsbereitschaft-wuerzburg/apps/form/zugaenge-edv-programme" target="_blank">4JUH Zugänge IT/Programme</a> gemeldet werden.
</p>
    ...
    <p class="pt-3">
        ...
        Diese Daten werden für eine Stunde zwischengespeichert, eine Änderung im Hiorg-Server ist erst mit Verzögerung sichtbar.
    </p>
@endsection
