...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('home') ? 'active' : '' }}" aria-current="page" href="{{route('home')}}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="pb-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l-2 0l9 -9l9 9l-2 0" /><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" /><path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" /></svg>
                        Home
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('me') ? 'active' : '' }}" aria-current="page" href="{{route('me')}}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('faq') ? 'active' : '' }}" aria-current="page" href="{{route('faq')}}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="pb-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('rules.show') ? 'active' : '' }}" href="{{route('rules.show')}}">
            ...
            <div class="d-flex">
                @if($impersonate !== null)
                    <span class="d-block text-white px-2">Simulation durch {{ $impersonate->name }}
                    <a class="btn btn-outline-light" href="{{ route('impersonate.back') }}">Zurück</a></span>
                @endif
